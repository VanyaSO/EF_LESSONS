    ...
    public void Init(ApplicationContext context)
    {
            ...
            (
                new Category
                {
                    Name = "Artistic", Description =
                        "The specificity of fiction is revealed by comparing it with art forms that use " +
                        "other material instead of verbal and linguistic material."
                },
                new Category
                {
                    Name = "Adventure", Description =
                        "The genre is close to action movies, but unlike the latter, in adventure films, " +
        ...
        if (!context.Books.Any())
        {
            Book theNightShip = new Book
            {
                ...
                Description =
                    "Based on a real-life event, an epic historical novel from the award-winning author of Things in Jars.",
                Price = 70,
            ...
            Book theOnlySurvivors = new Book
            {
                ...
                Description =
                    "Thrilling mystery about a group of former classmates who reunite to mark the tenth anniversary of a tragic accident—only" +
